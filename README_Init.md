...
- Use `:help` often; it’s *the* place to look things up.  
...
Happy editing! You now have a clear map of **what’s installed**, **what each option does**, and **every key you can press**.
